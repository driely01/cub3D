...
/*   Updated: 2023/08/21 17:48:22 by del-yaag         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	img->text.up_img = mlx_xpm_file_to_image(img->mlx, "textures/up.xpm",
			&img->text.up_width, &img->text.up_height);
	img->text.down_img = mlx_xpm_file_to_image(img->mlx, "textures/right.xpm",
			&img->text.down_width, &img->text.down_height);
	img->text.right_img = mlx_xpm_file_to_image(img->mlx, "textures/down.xpm",
			&img->text.right_width, &img->text.right_height);
	img->text.left_img = mlx_xpm_file_to_image(img->mlx, "textures/left.xpm",
